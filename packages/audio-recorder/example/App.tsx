...
class App extends React.Component {
    ...
    playMP3 = () => {
        if (recorder) {
            const mp3Blob = recorder.getMP3Blob();
    ...
    downloadMP3 = () => {
        if (recorder) {
            console.log("MP3: ", recorder.getMP3Blob());
            ...
            <Container className="App" style={{ margin: "20px 0" }}>
                ...
                <div>
                    <audio
                        ...
                        src={require("./assets/recorder.wav")}
                    ></audio>
                </div>
                <Form>
                ...
                <Divider />
                <div>
                    <Button onClick={this.playRecord}>录音播放</Button>
                    <Button onClick={this.pausePlay}>暂停播放</Button>
                    <Button onClick={this.resumePlay}>恢复播放</Button>
                    <Button onClick={this.stopPlay}>停止播放</Button>
                    <Button onClick={this.destroyRecord}>销毁实例</Button>
                </div>
                <Divider />
                <div>
                    <h3>下载</h3>
